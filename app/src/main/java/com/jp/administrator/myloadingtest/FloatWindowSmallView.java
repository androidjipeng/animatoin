...
public class FloatWindowSmallView extends LinearLayout{
    ...
    public FloatWindowSmallView(final Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.smallwindowlayout, this);
        final View view = findViewById(R.id.small_window_layout);
        viewWidth = view.getLayoutParams().width;
        viewHeight = view.getLayoutParams().height;
        TextView percentView = (TextView) findViewById(R.id.smalltv);
    ...
    private void doActoinMove(MotionEvent event) {
        xInScreen = event.getRawX();
        yInScreen = event.getRawY()-getStatusBarHeight();
        System.out.println("x---------->"+xInScreen+"y---------->"+yInScreen);
// 手指移动的时候更新小悬浮窗的位置
        updateViewPosition();
    }
